...
<template>
  <div class="space-y-8">
    <section>
      <h2 class="text-xs font-light tracking-[0.25em] uppercase text-muted mb-4">
        Biography
      </h2>
      <div class="space-y-6">
    ...
    <section>
      ...
      <div class="space-y-2">
        <a
          ...
          class="block font-light text-secondary/90 hover:text-accent transition-colors duration-300"
        >
          dusan@bebcak.com
        </a>
        <a
